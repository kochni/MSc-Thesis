...
models = ['GARCH (t)', 'GJR-GARCH (t)', 'T-GARCH (t)', 'E-GARCH (t)', 'Jump-Mix-GARCH (N)',
          'Guyon (t)', 'ELM-GARCH (t)',
...
# Selection Criteria
plots.selection_criteria(runs, models, 'GARCH (t)', 'Bitcoin')
...
# Coverages
plots.coverages(runs, models, pred_opts, 'moving', 500, None)


# Example prediction sets
models = ['T-GARCH (t)', 'ELM-GARCH (t)']
plots.exmpl_predsets(runs, models, 500, 1000, pred_opts)
